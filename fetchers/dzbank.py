...
BASE_URL = "https://jobs.dzbank.de"
JOBS_URL = "https://jobs.dzbank.de/search/?createNewAlert=false&q=&optionsFacetsDD_customfield1=&optionsFacetsDD_facility=&optionsFacetsDD_location=&locale=en_US"


def fetch(limit: int, source_name: str, **kwargs) -> list[JobPosting]:
    """
    Récupère les offres d'emploi pour DZ Bank (plateforme SuccessFactors).
    """
