# Fichier: fetchers/intesasanpaolo.py
...
BASE_URL = "https://jobs.intesasanpaolo.com"
JOBS_URL = "https://jobs.intesasanpaolo.com/search/?createNewAlert=false&q=&locationsearch=&optionsFacetsDD_facility=&optionsFacetsDD_country=&optionsFacetsDD_department=&optionsFacetsDD_customfield1="


def fetch(limit: int, source_name: str, **kwargs) -> list[JobPosting]:
    """
    Récupère les offres d'emploi pour Intesa Sanpaolo (plateforme SuccessFactors).
    """
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # 1. Gérer la bannière de cookies en italien
            try:
                cookie_button = page.get_by_role('button', name='Rifiuta')
