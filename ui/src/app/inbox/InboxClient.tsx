...
export default function InboxClient() {
  ...
  /* ---------------- Render ---------------- */
  // largeurs fixes pour stabilité (et troncature du Lieu)
  const COLW = {
  ...
  return (
    <>
                    ...
                    {paginated.map(({ job, bankId, dotStyle, isSeen, st }, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Lieu — troncature stricte */}
                          <TableCell className={`${COLW.loc} align-top`}>
                            <span className="truncate block max-w-[260px]" title={job.location ?? "-"}>
                              {job.location ?? "-"}
                            </span>
                          </TableCell>
      ...
      <style jsx global>{`
        ...
        /* ===== Icon toggles (Favori / Candidature) — actif en ROUGE ===== */
        .icon-btn{
