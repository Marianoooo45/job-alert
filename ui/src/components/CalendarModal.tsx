          ...
          >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-4 p-4 sm:p-5">
                  ...
                  <section className="rounded-xl border border-border/70 bg-card/40 p-3 sm:p-4">
                    ...
                    <div className="grid grid-cols-7 text-[11px] sm:text-xs text-muted-foreground mb-1 px-1">
                      ...
                      {grid.map((day) => {
                        ...
                        return (
                          <div
                            ...
                            className={`min-h-[76px] sm:min-h-[88px] rounded-lg border p-2 ${
                              inMonth
                                ? "border-border/70 bg-card/60 hover:bg-card"
                                : "border-border/40 bg-card/30 text-muted-foreground"
                            }`}
                          >
                            <div className="text-[11px] sm:text-xs mb-1 opacity-70">
                              {day.getDate()}
                            </div>
                  ...
                  <aside className="rounded-xl border border-border bg-card p-3 sm:p-4 space-y-3">
